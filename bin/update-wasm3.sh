...
function replace_wasm3_with_branch() {
  ...
  find wasm3/source -regex ".*\.c" -exec cp {} ../vendor/cwasm3/Sources/CWasm3/ \;
  find wasm3/source | \
    grep -E "(source/|source/extensions/)(m3|was).*\.h" | \
    xargs -I INPUT_FILE cp INPUT_FILE ../vendor/cwasm3/Sources/CWasm3/include/
  rm ../vendor/cwasm3/Sources/CWasm3/include/m3.h &>/dev/null # remove this deprecated header
  rm ../vendor/cwasm3/Sources/CWasm3/include/m3_api_defs.h &>/dev/null # remove this deprecated header
